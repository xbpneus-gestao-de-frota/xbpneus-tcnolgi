...
class UsuarioRecapagemManager(BaseUserManager):
    """Manager customizado para UsuarioRecapagem"""
...
class UsuarioRecapagem(AbstractBaseUser, PermissionsMixin):
    """Modelo de usuário para Recapagem"""
    ...
    groups = models.ManyToManyField(
        ...
        verbose_name='groups',
        blank=True,
        related_name='recapagem_users',
        related_query_name='recapagem_user',
    )
    ...
    objects = UsuarioRecapagemManager()
    
    USERNAME_FIELD = 'email'
    REQUIRED_FIELDS = ['nome_razao_social', 'cnpj']
    
    class Meta:
        verbose_name = 'Usuário Recapagem'
        verbose_name_plural = 'Usuários Recapagem'
        db_table = 'recapagem_usuario'
