...
class UsuarioTransportadorManager(BaseUserManager):
    """Manager customizado para o modelo ``UsuarioTransportador``."""
    ...
    def create_superuser(self, email, password=None, **extra_fields):
        ...
        extra_fields.setdefault(
            "cnpj", os.getenv("DJANGO_SUPERUSER_CNPJ", "00000000000000")
        )
        extra_fields.setdefault(
            "telefone", os.getenv("DJANGO_SUPERUSER_TELEFONE", "0000000000")
        )
