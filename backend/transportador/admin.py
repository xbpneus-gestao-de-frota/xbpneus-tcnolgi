...
class UsuarioTransportadorAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Informações Pessoais', {'fields': ('nome_razao_social', 'cnpj', 'telefone')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'nome_razao_social', 'cnpj', 'telefone', 'password1', 'password2'),
        }),
    )
