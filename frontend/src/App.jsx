...
import RelatoriosDashboard from "./pages/transportador/RelatoriosDashboard";
  ...
  return (
    <Routes>
      ...
      {/* Rotas para Transportador */}
            <Route path="/transportador/dashboard" element={<ProtectedRoute allowedRoles={["transportador"]}>
        <Route path="motoristas" element={<RequireAuth><MotoristasDashboard /></RequireAuth>} /><RequireAuth><LayoutTransportador /></RequireAuth></ProtectedRoute>}>
      ...
      {/* Hub de funcionalidades com dashboard lateral */}
      ...
      {/* Aliases para compatibilidade com Sidebar antigo */}
      <Route path="/dashboard" element={<Navigate to="/transportador/dashboard" replace />} />
      <Route path="/dashboard/*" element={<Navigate to="/transportador/dashboard" replace />} />
  <Route path="/dashboard/transportador" element={<ProtectedRoute><TransportadorDashboard /></ProtectedRoute>} />
</Routes>
  );
}
